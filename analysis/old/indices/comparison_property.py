...
for p, cmap in zip(['log10Mstar_30','AFUV','log10sSFR'], [cm.viridis, cm.magma, cm.coolwarm_r]):
    ...
    # --- make corner plot
    fig = flares_analysis.corner(D, properties, s, limits = limits, scatter_colour_quantity = p, scatter_cmap = cmap, full_width = False)


    fig.savefig(f'figs/diagnostic_comparison_{p}.pdf')
