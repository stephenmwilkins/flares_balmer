...
fig = flares_analysis.corner3(D, properties, s, {'beta': cm.viridis, 'log10BB': cm.plasma, 'log10HbetaEW': cm.inferno}, limits = limits, full_width = False)


fig.savefig(f'figs/diagnostic_comparison.pdf')
