...
for q in ['log10BB', 'log10HbetaEW','beta']:
    ...
    properties = [q, 'log10sSFR', 'log10sSFR', 'AFUV', 'log10M*/LV']
    ...
    # --- make corner plot
    fig = flares_analysis.linear(D, properties, s, limits = limits, scatter_colour_quantity = 'log10Mstar_30', scatter_cmap = cm.viridis)

    fig.savefig(f'figs/{q}_properties.pdf')
