...
for q in ['log10BB', 'log10HbetaEW','beta']:
    ...
    fig = fa.linear_redshift(D, fl.zeds, 'log10Mstar_30', q, s, limits = limits, scatter_colour_quantity = 'log10FUV', scatter_cmap = cm.inferno)

    fig.savefig(f'figs/{q}_redshift.pdf')
