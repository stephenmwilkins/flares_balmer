    ...
    for log10Z in [-4, -3, -2]:
        ...
        for fesc in [0.0, 0.5, 0.9, 1.0]:
            ...
            for log10tau_V in [-5., -1.0, -0.3, 0.0]:
                ...
                data = Table([log10_durations]+[d[f] for f in filters]+[d[l] for l in ['Hbeta_EW','OIIIr_EW','OIIIb_EW','OIIIHbeta_EW']], names=['log10_duration']+filters+['Hbeta_EW','OIIIr_EW','OIIIb_EW','OIIIHbeta_EW'])
